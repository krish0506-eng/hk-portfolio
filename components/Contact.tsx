          ...
          >
            <div className="glass glow-border rounded-3xl p-6 sm:p-8 h-full flex flex-col justify-between gap-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { icon: FiMail, label: "Email", href: "mailto:krishnaahari05@gmail.com", color: "#ff2d78" },
                  ...
                  { icon: FiMessageCircle, label: "WhatsApp", href: "https://wa.me/916379726858?text=Hi%20Hari%2C%20I%20saw%20your%20portfolio%20and%20would%20like%20to%20connect!", color: "#25d366" },
                  ...
                  <motion.a
                    ...
                    className="rounded-2xl border border-border/60 bg-bg/40 px-4 py-4 flex items-center gap-3 text-sm text-light font-body transition-colors"
                  >
